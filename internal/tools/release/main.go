...
import (
	...
	"github.com/nuetzliches/hookaido/v2/internal/release/sbom"
)
...
func buildAndPackageTarget(cfg releaseConfig, target buildTarget, archivePath, safeVersion string) error {
	...
	ldflags := fmt.Sprintf(
		"-X github.com/nuetzliches/hookaido/v2/internal/app.version=%s -X github.com/nuetzliches/hookaido/v2/internal/app.commit=%s -X github.com/nuetzliches/hookaido/v2/internal/app.buildDate=%s",
		cfg.Version,
		cfg.Commit,
		cfg.BuildDate,
	)
