...
func printHelp() {
	...
	fmt.Fprintln(os.Stdout, "  hookaido run --config ./Hookaidofile [--db ./.data/hookaido.db] [--postgres-dsn postgres://user:pass@host:5432/db] [--pid-file ./hookaido.pid] [--watch] [--watch-interval 30s] [--log-level info] [--dotenv ./.env]")
